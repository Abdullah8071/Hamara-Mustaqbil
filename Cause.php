...
<body>
    ...
    <div class="popular_causes_area pt-120">
        <div class="container">
            <div class="row">
            <?php
$ret=mysqli_query($con,"select * from cause order by postingDate desc");
...
{?>	
                <div class="col-lg-4 col-md-6">
                    <div class="single_cause">
                        <div class="thumb">
                        <a><img  src="admin/editor/causeimage/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['CauseImage']);?>" style="width:350px;height:260px;" ></a>
                        </div>

                        <div class="causes_content" style=" word-wrap: break-word;">

                            <div class="balance d-flex justify-content-between align-items-center">
                                <span> Progress :     <?php echo htmlentities($row['Percentage']);?>% </span>
                            </div>
                            <div class="balance d-flex justify-content-between align-items-center">
                                <span> Raised Amount Rs :  <?php echo htmlentities($row['RaisedAmount']);?>  </span>
                            </div>
                            <div class="balance d-flex justify-content-between align-items-center">
                                <span>Goal Amount Rs : <?php echo htmlentities($row['GoalAmount']);?>  </span>
                            </div>
                            <a href=""><h4><?php echo htmlentities($row['CauseName']);?></h4></a>
                            <p style=" word-wrap: break-word;white-space: pre-wrap;"><?php echo htmlentities($row['CauseDescription']);?></p>
                        </div>
                    </div>
                </div>
                <?php } } else {?>
	
                    <div class="col-lg-4 col-md-6"> <p>No Cause Found</p>
    </div>
