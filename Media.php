...
$ret=mysqli_query($con,"select * from media");
...
<body>
    ...
    <!-- bradcam_area_start  -->
    <div class="bradcam_area breadcam_bg overlay d-flex align-items-center justify-content-center" style=" background-image: url(img/MP1.HEIC);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
        ...
        <div class="section-top-border">
				...
				<div class="row">
					<div class="col-lg-12">
                        ...
                        Essential for the organisation’s ever-growing reach, the Media
                        Department manages Hamara Mustaqbil’s social media accounts. From designing posters to
                        ID cards to running online campaigns, this department does it all.
                        </blockquote>
					</div>
				</div>
            </div>
...
{?>	
					<div class="col-md-3" style="margin-top:5%">
                        <a><img  src="admin/mediaimage/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['MediaImage']);?>" class="img-fluid"></a>
					</div>
					<div class="col-md-9 mt-sm-20" style=" word-wrap: break-word;margin-top:5%">
                        <h3><?php echo htmlentities($row['MediaName']);?></h3>
                        <p style=" word-wrap: break-word;white-space: pre-wrap;"><?php echo htmlentities($row['MediaDescription']);?></p>
                        <a href="<?php echo htmlentities($row['MediaLink']);?>">View PDF</a>
                    </div>
                    
                    <?php } } else {?>
                        <div class="col-md-3"> <p>No Media Found</p>
    </div>
