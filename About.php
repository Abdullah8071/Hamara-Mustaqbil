...
<body>
    ...
    <div class="whole-wrap">
        <div class="container box_1170">
            ...
            <div class="section-top-border">
                <h3 class="mb-30">About HM</h3>
                <div class="row">
                    <div class="col-lg-12">
                        <blockquote class="generic-blockquote" style="font-family: 'Poppins', sans-serif;">
                            Hamara Mustaqbil is a non-profit NGO, initiated by some students of Dow Medical College, that strives towards both the education and holistic development of our youth, primarily focusing on the underprivileged.

                            Our primary aim is to take the underprivileged children of Pakistan, those who were never given a decent chance at life, and arm them with the necessary tools that can pave their road to a better tomorrow.

                            Our secondary aim is to approach different schools of Pakistan with entire modules dedicated to conducting lectures and activities regarding the development of a student outside of conventional education.
            ...
            <div class="section-top-border">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <blockquote class="generic-blockquote" style="font-family: 'Poppins', sans-serif;">
                            Investing in Pakistan's youth, as they pave the way for a brighter future for this nation
                        </blockquote>
                    </div>
                </div>
            </div>
            <div class="section-top-border">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <blockquote class="generic-blockquote" style="font-family: 'Poppins', sans-serif;">
                            To provide education, counseling and to disseminate the skills of leadership and social etiquette,
                            as well as the importance of mental and physical health amongst the youth of Pakistan
    ...
    <div class="our_volunteer_area section_padding">
        <div class="container">
            ...
            <?php
            $query = "SELECT * FROM team WHERE Category = 'Board of Directors'";
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single_volenteer">
                        <div class="volenteer_thumb">
                            <img src="admin/memberimage/<?php echo htmlentities($row["id"]); ?>/<?php echo htmlentities($row["MemberImage"]); ?>" alt="" style="border-radius: 200px;width:170px;height:170px;">
                        </div>
                    ...
                    <div class="p-3 mb-5" style="margin-top: 10px; background-color: #f9f9ff;   border-radius: 10px;">
                        <p style=" word-wrap: break-word;white-space: pre-wrap;"><?php echo $row["Description"]; ?></p>
                    </div>
                </div>
                <?php
                if ($cnt % 3 == 2) {
            ...
            if ($started == 1) {
                ...
                <div class="col-lg-5 col-md-6">
                    <p>No Board of Director Found</p>
                </div>
            <?php }
