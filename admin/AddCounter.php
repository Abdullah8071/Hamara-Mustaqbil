...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		//for getting counter id
		$query = mysqli_query($con, "select max(id) as pid from counter");
		$result = mysqli_fetch_array($query);
		$counterid = $result['pid'] + 1;


		$query = "INSERT INTO counter (id,Years,Beneficiaries,Projects,Workshops) VALUES ($counterid,'$years','$beneficiaries','$projects','$workshops')";
		$sql = mysqli_query($con, $query) or die("Unsuccessful Retry ");
		$_SESSION['msg'] = "Counter Inserted Successfully !!";
	}
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										<div class="control-group">
											<label class="control-label" for="basicinput">Years</label>
											<div class="controls">
												<input type="text" name="Years" placeholder="Enter Years" class="span8 tip" required>
											</div>
										</div>
										...
										<div class="control-group">
											...
											<div class="controls">
												<input type="text" name="Beneficiaries" placeholder="Beneficiaries" class="span8 tip" required>
											</div>
										</div>

										<div class="control-group">
											<label class="control-label" for="basicinput">Projects</label>
											<div class="controls">
												<input type="text" name="Projects" placeholder="Enter Projects" class="span8 tip" required>
											</div>
										</div>

										<div class="control-group">
											<label class="control-label" for="basicinput">Workshops</label>
											<div class="controls">
												<input type="text" name="Workshops" placeholder="Enter Workshops" class="span8 tip" required>
											</div>
										</div>
