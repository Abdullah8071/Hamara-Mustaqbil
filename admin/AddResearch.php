...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$query = "INSERT INTO research (id,ResearchName,ResearchDescription,ResearchLink) VALUES (NULL,'$researchname','$researchdescription','$researchlink')";
		$sql = mysqli_query($con, $query) or die("Unsuccessful Retry ");
		$_SESSION['msg'] = "Research Inserted Successfully !!";
	}
	...
	<head>
		...
		<title>Admin | Add Research</title>
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										<div class="control-group">
											<label class="control-label" for="basicinput">Research Name</label>
											<div class="controls">
												<input type="text" name="ResearchName" placeholder="Enter Research Name" class="span8 tip" required>
											</div>
										</div>


										<div class="control-group">
											<label class="control-label" for="basicinput">Research Description</label>
											<div class="controls">
												<textarea name="ResearchDescription" placeholder="Enter Research Description" rows="6" class="span8 tip"></textarea>
                                        ...
                                        <div class="control-group">
											<label class="control-label" for="basicinput">Research Link</label>
											<div class="controls">
												<input type="text" name="ResearchLink" placeholder="Enter Research Link" class="span8 tip" required>
											</div>
										</div>
