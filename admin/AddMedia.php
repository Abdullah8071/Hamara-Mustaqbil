...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		// $mediaimage = $_FILES["MediaImage"]["name"];
		$mediaimage = str_replace(' ', '', $_FILES["MediaImage"]["name"]);

		//for getting media id
		$query = mysqli_query($con, "select max(id) as pid from media");
		$result = mysqli_fetch_array($query);
		$mediaid = $result['pid'] + 1;
		...
		$query = "INSERT INTO media (id,MediaName,MediaDescription,MediaLink,MediaImage) VALUES ($mediaid,'$medianame','$mediadescription','$medialink','$mediaimage')";
		$sql = mysqli_query($con, $query) or die("Unsuccessful Retry ");
		$_SESSION['msg'] = "Media Inserted Successfully !!";
	}
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										<div class="control-group">
											<label class="control-label" for="basicinput">Media Name</label>
											<div class="controls">
												<input type="text" name="MediaName" placeholder="Enter Media Name" class="span8 tip" required>
											</div>
										</div>


										<div class="control-group">
											<label class="control-label" for="basicinput">Media Description</label>
											<div class="controls">
												<textarea name="MediaDescription" placeholder="Enter Media Description" rows="6" class="span8 tip"></textarea>
                                        ...
                                        <div class="control-group">
											<label class="control-label" for="basicinput">PDF/Media Link</label>
											<div class="controls">
												<input type="text" name="MediaLink" placeholder="Enter PDF/Media Link" class="span8 tip" required>
											</div>
										</div>
										...
										<div class="control-group">
											<label class="control-label" for="basicinput">Media Image</label>
											<div class="controls">
												<input type="file" accept="image/*" name="MediaImage" id="productimage1" value="" class="span8 tip" required>
											</div>
										</div>
