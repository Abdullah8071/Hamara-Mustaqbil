...
$ret=mysqli_query($con,"SELECT * FROM editor WHERE username='$username' and password='$password'");
$num=mysqli_fetch_array($ret);
if($num>0)
{
$extra="AddCause.php";//
$_SESSION['elogin']=$_POST['username'];
$_SESSION['id']=$num['id'];
...
<head>
	...
	<title>HAMARA MUSTAQBIL | Editor login</title>
