...
if (strlen($_SESSION['elogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$dir = "causeimage/$causeid";
		if (!is_dir($dir)) {
			mkdir("causeimage/" . $causeid);
		}

		move_uploaded_file($_FILES["CauseImage"]["tmp_name"], "causeimage/$causeid/" . $_FILES["CauseImage"]["name"]);
