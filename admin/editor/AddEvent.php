...
if (strlen($_SESSION['elogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$dir = "eventimage/$eventid";
		if (!is_dir($dir)) {
			mkdir("eventimage/" . $eventid);
		}

        move_uploaded_file($_FILES["EventImage1"]["tmp_name"], "eventimage/$eventid/" . str_replace(' ', '', $_FILES["EventImage1"]["name"]));
        move_uploaded_file($_FILES["EventImage2"]["tmp_name"], "eventimage/$eventid/" . str_replace(' ', '', $_FILES["EventImage2"]["name"]));
        move_uploaded_file($_FILES["EventImage3"]["tmp_name"], "eventimage/$eventid/" . str_replace(' ', '', $_FILES["EventImage3"]["name"]));
        move_uploaded_file($_FILES["EventImage4"]["tmp_name"], "eventimage/$eventid/" . str_replace(' ', '', $_FILES["EventImage4"]["name"]));
