...
<body>
    ...
    <!-- bradcam_area_start  -->
    <div class="bradcam_area breadcam_bg overlay d-flex align-items-center justify-content-center" style=" background-image: url(img/mh1.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-xl-12">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="single_cause">
                        ...
                        <div class="causes_content">
                            ...
                            <?php
                                $ret=mysqli_query($con,"select * from mental where id = (select max(id) as pid from mental)");
            ...
            <div class="section-top-border">
                <h3>The skills and training workshop</h3>
                            ...
                            <div class="row gallery-item">
                                <div class="col-md-4">
                                    <a href="admin/mentalimage/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['EventImage']);?>" class="img-pop-up">
                                       
                                      
                                        <div class="single-gallery-image" style="background: url(admin/mentalimage/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['EventImage']);?>);"></div>
                                    </a>
                                </div>

                                <div class="col-md-4">
                                    <a href="admin/mentalimage/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['EventImage2']);?>" class="img-pop-up">
                                       
                                      
                                        <div class="single-gallery-image" style="background: url(admin/mentalimage/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['EventImage2']);?>);"></div>
                                    </a>
                                </div>

                                <div class="col-md-4">
                                    <a href="admin/mentalimage/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['EventImage3']);?>" class="img-pop-up">
                                       
                                      
                                        <div class="single-gallery-image" style="background: url(admin/mentalimage/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['EventImage3']);?>);"></div>
                                    </a>
                                </div>
                            </div>
                            <?php } else { ?>
