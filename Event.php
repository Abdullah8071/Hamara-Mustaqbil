...
<body>
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="section_title text-center mb-55" style="margin-top:5%;">
...
<div class="popular_causes_area pt-120">
        <div class="container">
            <div class="row">
            <?php
$ret=mysqli_query($con,"select * from event where EventCategory = 'Upcoming Event' order by EventDate desc ");
...
{?>	
                <div class="col-lg-4 col-md-6">
                    <div class="single_cause">
                        <div class="thumb">
                        <a><img  src="admin/editor/eventimage/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row["EventImage1"]); ?> "style="width:350px;height:260px;"></a>
                        </div>
                        <div class="causes_content" style=" word-wrap: break-word;">
                            ...
                            <div class="balance d-flex justify-content-between align-items-center">
                                ...
                                <span><?php echo htmlentities($row["EventDate"]); ?></span>
                            </div>
                            <a href=""><h4><?php echo htmlentities($row["EventName"]); ?></h4></a>
                            <div class="row gallery-item">
                                <div class="col-md-12">
                                    <!-- <a href="img/elements/g1.jpg" class="img-pop-up">
                                    <div class="single-gallery-image" style="background: url(img/elements/g1.jpg);"></div>
                                </a> -->
                                    <a href="admin/editor/eventimage/<?php echo htmlentities($row["id"]); ?>/<?php echo htmlentities($row["EventImage2"]); ?>" class="img-pop-up">
                                        <div class="" style="">
                                        <h6>Click to see event images</h6>
                                        </div>
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="admin/editor/eventimage/<?php echo htmlentities($row["id"]); ?>/<?php echo htmlentities($row["EventImage3"]); ?>" class="img-pop-up">
                                        <div class="" style=""></div>
                                    </a>
                                </div>
                                <div class="col-md-4">
                                    <a href="admin/editor/eventimage/<?php echo htmlentities($row["id"]); ?>/<?php echo htmlentities($row["EventImage4"]); ?>" class="img-pop-up">
                                        <div class="" style=""> </div>
                                    </a>
                                </div>
                            </div>
                            <?php
                            $str = $row["EventDescription"];
                            $id = strval($row["id"]);
                            $dotId = 'dots'.$id;
                            $moreId = 'more'.$id;
                            $btnId = 'myBtn'.$id;
                            ?>                             
                            <p style=" word-wrap: break-word;white-space: pre-wrap;"><?php
                                    echo htmlentities(substr($str,0,150)).'<span id='.$dotId.'>...</span><span id='.$moreId.' style = "display: none">'.htmlentities(substr($str,150,strlen($str))).'</span>';
                                ?></p>
                            
                            <?php
                            echo '<button type="button" class="btn btn-primary" style="background-color:#3CC78F;border-radius:30px;color:white"onclick="myFunction('.$id.')" id='.$btnId.'>Read More</button>';
                            ?>
                ...
                <?php } } else {?>
                    ...
                    <div class="col-lg-4 col-md-6"> <p>No Event Found</p>
    </div>
...
<!-- Event end -->
    ...
    <div class="row justify-content-center">
        <div class="col-lg-6">
            <div class="section_title text-center mb-55" style="margin-top:5%;">
                <h3><span>Ongoing Events</span></h3>
            </div>
        </div>
    </div>
...
<div class="popular_causes_area pt-120">
        <div class="container">
            <div class="row">
            <?php
$ret=mysqli_query($con,"select * from event where EventCategory = 'Ongoing Event' order by EventDate desc ");
$num=mysqli_num_rows($ret);
if($num>0)
{
while ($row=mysqli_fetch_array($ret)) 
...
<div class="popular_causes_area pt-120">
        <div class="container">
            <div class="row">
            <?php
$ret=mysqli_query($con,"select * from event where EventCategory = 'Past Event' order by EventDate desc ");
$num=mysqli_num_rows($ret);
if($num>0)
{
while ($row=mysqli_fetch_array($ret)) 
  ...
  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
    ...
    <script>
        function myFunction(id) {
          var did = "dots";
          var dots = document.getElementById(did.concat(id));
          var mid = "more";
          var moreText = document.getElementById(mid.concat(id));
          console.log(moreText);
          var bid = "myBtn";
          var btnText = document.getElementById(bid.concat(id));
          console.log(btnText);
